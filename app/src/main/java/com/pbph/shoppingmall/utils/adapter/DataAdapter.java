...
public class DataAdapter extends BaseAdapter {
    ...
    private OnItemViewClickListener listener;//列表item中控件点击事件
    ...
    private DataAdapter(Object activity, View view, Class viewholder,
        ...
        if (view instanceof ListView) {
            ...
            headViewCount = listView.getHeaderViewsCount();
    ...
    public interface OnItemViewClickListener<T extends ViewHolder> {
        void onItemViewClick(int rid, T holder, Object... objects);
    }
}