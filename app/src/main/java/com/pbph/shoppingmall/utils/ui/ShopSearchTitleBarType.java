...
import com.pbph.shoppingmall.module.shopdetail.shopsearch.ShopWithinSearchActivity;
...
public class ShopSearchTitleBarType {
    Activity activity;
    public View layout;
    ...
    public ShopSearchTitleBarType(Activity activity, String title, boolean right, int searchType) {
    ...
    public ShopSearchTitleBarType(Activity activity, String title, boolean right, int searchType, int id) {
        ...
        public void onCanClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.edt_search: {
                    activity.startActivity(new Intent(activity, ShopWithinSearchActivity.class)
                            .putExtra("storeId", id)
                    );
                ...
                case R.id.tv_shop_type: {
                    activity.startActivity(new Intent(activity, GoodsTypeActivity.class).putExtra
                            ("storeId", id));
                }
