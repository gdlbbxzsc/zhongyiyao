...
public class EvaluateOrdersActivity extends BaseActivity<Presenter> implements Contract.View, CompoundButton.OnCheckedChangeListener, ViewPager.OnPageChangeListener {
    ...
    protected int layoutResID() {
        return R.layout.activity_evaluateorders;
    }
    ...
    protected void initView() {
        ...
        commonTitlebar = new CommonTitlebar(this, "我的评价", true);
...
//        订单类型（0：全部，1：待付款，2：待收货，3：已完成，4：已取消，5：待评价，6：以评价并以晒单，7：售后申请，8：申请记录）
        ...
        pagerAdapter.list.add(OrdersFragment.newInstance(5));
        pagerAdapter.list.add(OrdersFragment.newInstance(6));
