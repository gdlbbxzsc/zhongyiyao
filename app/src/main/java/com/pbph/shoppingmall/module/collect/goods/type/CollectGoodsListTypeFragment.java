...
public class CollectGoodsListTypeFragment extends BaseFragmentV4<Presenter> implements Contract.View, AdapterView.OnItemClickListener {
    ...
    List<GetCustomerFollowListResponse.DataBean.GoodsInfoBean.ListBean> listBean = new ArrayList<>();//添加到购物车的货物


    public static CollectGoodsListTypeFragment newInstance() {

        CollectGoodsListTypeFragment f = new CollectGoodsListTypeFragment();
