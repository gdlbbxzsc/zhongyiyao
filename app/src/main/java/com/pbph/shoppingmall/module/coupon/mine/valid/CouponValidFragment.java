package com.pbph.shoppingmall.module.coupon.mine.valid;
...
public class CouponValidFragment extends BaseFragmentV4<Presenter> implements Contract.View, AdapterView.OnItemClickListener {
    ...
    public void initView(View view) {
        ...
        adapter = new CouponListDataAdapter(this, listView, CouponValidViewHolder.class);
