...
public class FlowLayout extends ViewGroup implements CompoundButton.OnCheckedChangeListener {
    ...
    public int getTilteId() {
        return tilteId;
    }

    public void setTilteId(int tilteId) {
        this.tilteId = tilteId;
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked) {
            ...
            if (listener != null) {
                ...
                listener.onSelected(buttonView,getTitle(),getTilteId(), buttonView.getText()
                        .toString(), buttonView.getId());
            }
        }
