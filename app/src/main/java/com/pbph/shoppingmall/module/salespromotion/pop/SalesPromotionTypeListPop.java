...
public class SalesPromotionTypeListPop extends PopupWindow {
    ...
    public SalesPromotionTypeListPop(Activity activity) {
        this(activity, null);
    }

    public SalesPromotionTypeListPop(Activity activity, View showView) {
        super(activity);
        ...
        adapter = new DataAdapter(activity, gridView, SalesPromotionTypeListPopViewHolder.class);
