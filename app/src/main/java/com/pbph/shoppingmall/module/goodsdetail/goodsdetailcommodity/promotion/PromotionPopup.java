...
public class PromotionPopup   extends PopupWindow {
    ...
    public PromotionPopup(Context context, View showView,List<PromotionBean> promotionBeans) {
        super(context);
        ...
        View view = inflater.inflate(R.layout.pop_list_promotion, null);
        list_view_coupon = view.findViewById(R.id.list_view_coupon);
        promotionAdapter = new PromotionAdapter(context);
        promotionAdapter.setPromotionBeans(promotionBeans);
        list_view_coupon.setAdapter(promotionAdapter);
//        list_view_coupon.setDividerHeight(2);
//        list_view_coupon.setDivider(Color.parseColor(""));
