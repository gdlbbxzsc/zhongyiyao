package com.pbph.shoppingmall.module.collect.shops.common;
...
public class CollectShopsListCommonFragment extends BaseFragmentV4<Presenter> implements Contract.View, AdapterView.OnItemClickListener {
    ...
    public static CollectShopsListCommonFragment newInstance(String id) {

        CollectShopsListCommonFragment f = new CollectShopsListCommonFragment();
