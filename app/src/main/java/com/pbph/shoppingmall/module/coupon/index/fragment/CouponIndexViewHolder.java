...
public class CouponIndexViewHolder extends ViewHolder<GetAllCouponListResponse.DataBean.AllCouponListBean.ListBean> {
...
//            ivCouponHad.setVisibility(View.VISIBLE);
            ...
            adapter.getListener().onItemViewClick(v.getId(), CouponIndexViewHolder.this);
        }
    };
}
