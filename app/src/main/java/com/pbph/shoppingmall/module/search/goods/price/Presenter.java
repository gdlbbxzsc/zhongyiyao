package com.pbph.shoppingmall.module.search.goods.price;
...
public class Presenter<T extends Contract.View> extends BasePresenter<T> implements Contract.Presenter {
    ...
    public void subscribe() {  //  第一次创建默认执行的事情
        ...
        subscribeRxBus2flushListByPrice();
    ...
    public void unsubscribe() { //销毁时执行的事情
        ...
        unSubscribeRxBus2flushListByPrice();
    ...
    @Override
    public void subscribeRxBus2flushListByPrice() {
        RxBusF.register0(Presenter.this, SearchPriceMsg.class, it -> {
//            根据此值更新数据
    ...
    @Override
    public void unSubscribeRxBus2flushListByPrice() {
        RxBusF.removeDisposable0(Presenter.this, SearchPriceMsg.class);
    }
