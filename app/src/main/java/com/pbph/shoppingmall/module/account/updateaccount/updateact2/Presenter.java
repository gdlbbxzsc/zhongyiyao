...
import com.pbph.shoppingmall.model.request.SendSmsValCodeForBindNewPhoneRequest;
...
public class Presenter<T extends Contract.View> extends BasePresenter<T> implements Contract.Presenter {
    ...
    public void subscribe() {  //  第一次创建默认执行的事情
        msg.step = MsgType.MsgType_Update_Act_Step2;
    }
    ...
    public void getNumCode(String acc) {
        ...
        SendSmsValCodeForBindNewPhoneRequest<ResultResponse> sendSmsValCodeRequest = new SendSmsValCodeForBindNewPhoneRequest<>();
    ...
    @Override
    public void submitAccountCode(final String acc, String code) {
        ...
        moblieLoginRequest.request().subscribe(
                new LogoutConsumer<ResultResponse>(getBaseView().getContext()) {
                    ...
                    public void onDo(ResultResponse vo) throws Exception {
                        ...
                        MyApplication.userInfo.setMobile(acc);
