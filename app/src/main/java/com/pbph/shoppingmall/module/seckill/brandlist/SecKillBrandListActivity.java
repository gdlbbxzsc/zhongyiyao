package com.pbph.shoppingmall.module.seckill.brandlist;
...
public class SecKillBrandListActivity extends BaseActivity<Presenter> implements Contract.View, AdapterView.OnItemClickListener {
    ...
    protected int layoutResID() {
        return R.layout.activity_seckillbrandlist;
    }
    ...
    protected void initView() {
        commonTitlebar = new CommonTitlebar(this, "品牌秒杀", true);
        ...
        adapter = new DataAdapter(this, listView, SecKillBrandListViewHolder.class);
