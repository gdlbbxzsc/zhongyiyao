...
public class CouponValidViewHolder extends ViewHolder {
    ...
    protected int getLayout() {
        return R.layout.listview_couponvalid1;
    }
    ...
    OnSingleClickListener listener = new OnSingleClickListener() {
        ...
        public void onCanClick(View v) {
            Toast.makeText(adapter.context, "valid", Toast.LENGTH_SHORT).show();
        }
    };
}
