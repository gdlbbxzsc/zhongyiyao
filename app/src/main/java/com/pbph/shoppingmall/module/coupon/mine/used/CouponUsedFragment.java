...
public class CouponUsedFragment extends BaseFragmentV4<Presenter> implements Contract.View, AdapterView.OnItemClickListener {
    ...
    public void initView(View view) {
        ...
        adapter = new CouponListDataAdapter(this, listView, CouponUsedViewHolder.class);
