...
public class MessageTypeLogisticsFragment extends BaseFragmentV4<Presenter> implements Contract.View, AdapterView.OnItemClickListener {
    ...
    protected int layoutResID() {
        return R.layout.fragment_messagetype_logistics;
    }
    ...
    public void initView(View view) {
        ...
        adapter = new DataAdapter(this, listView, LogisticsViewHolder.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        GetMyMessageListResponse.DataBean.MessageListBean.ListBean vo = (GetMyMessageListResponse.DataBean.MessageListBean.ListBean) adapter.getItem(position);

        startActivity(new Intent(getContext(), LogisticsDetailActivity.class)
                .putExtra("orderId", String.valueOf(vo.getMessageClassifyId()))
        );
    }
