package com.pbph.shoppingmall.module.typegoodslist.comprehensive;
...
public class ComprehensiveFragment extends BaseFragmentV4<ComprehensivePresenter> implements
    ...
    public static ComprehensiveFragment newInstance(String cateId, String sort, String keyword) {
        ComprehensiveFragment fragment = new ComprehensiveFragment();
        Bundle args = new Bundle();
        args.putString(CATE_ID, cateId);
    ...
    public void initData() {
        if (getArguments() != null) {
            cateId = getArguments().getString(CATE_ID);
...
//        searchProductRequest.thirdCats = thirdCats;
    ...
    public void setScreenData(String brands, String priceMin, String priceMax, String params) {
        getGoodsTypeListData(brands, priceMin, priceMax, params);
    }
