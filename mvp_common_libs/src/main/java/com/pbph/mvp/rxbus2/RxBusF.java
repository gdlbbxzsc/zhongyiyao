...
public class RxBusF {
    ...
    public static <T> void register0(BaseFragmentV4 key, Class<T> clz, Consumer<T> consumer) {

        Disposable disposable = register0(clz, consumer);

        addDisposable0(key.toString() + clz.getName(), disposable);
    }
    ...
    public static <T> void register0(BasePresenter key, Class<T> clz, Consumer<T> consumer) {
    ...
    public static <T> void removeDisposable0(BaseFragmentV4 key, Class<T> clz) {
    ...
    public static <T> void removeDisposable0(BasePresenter key, Class<T> clz) {
        removeDisposable0(key.toString() + clz.getName());
    }
